(function ($) {
    ...
    TimsAccount
$("#TimsAccount").submit(function(event) {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response == "success") {
                ...
                document.getElementById('kraNumber').value = "";
                document.getElementById('county').value = "";
                document.getElementById('subcounty').value = "";
                document.getElementById('securityquiz').value = "";
                document.getElementById('paddress').value = "";
                document.getElementById('pcode').value = "";
                document.getElementById('phyAddress').value = "";
